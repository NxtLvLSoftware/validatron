...
class Validator implements IValidatable {
	...
	/**
	 * Validate an array of data against the rules previously specified.
	 *
	 * @param array $data
	 *
	 * @return \nxtlvlsoftware\validatron\ValidationResult
	 */
	public function validate(array $data) : ValidationResult {
		$failures = new FailureList();
		$input = new ValueList($data);
		$output = new ValueList();

		foreach($this->collections as $collection) {
			$collection->validate($failures, $input, $output);
		}
