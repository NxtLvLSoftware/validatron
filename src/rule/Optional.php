...
use nxtlvlsoftware\validatron\rule\traits\ChecksEmpty;
...
class Optional extends Rule {
	 ...
	 * @param $default
	 *
	 * @return \nxtlvlsoftware\validatron\rule\Optional
	 */
	public function fallback($default) : Optional {
